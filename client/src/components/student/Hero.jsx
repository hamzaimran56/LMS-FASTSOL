...
const Hero = () => {
  return (
    ...
    <p className='md:block hidden text-gray-500 max-w-2xl mx-auto'>Explore a wide range of courses and unlock your potential with our comprehensive learning platform. Whether you're a student or an educator, we have the resources you need to succeed.</p>

    <p className='md:hidden text-gray-500 max-w-sm mx-auto'>
      Explore top courses and unlock your potential with our all-in-one learning platform.
    </p>
    <SearchBar />
    </div>
  )
